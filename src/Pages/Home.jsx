...
export const Home = () => {
  ...
  const check = (id) => {
    ...
    if (exits.length > 0) {
      return alert(
        "The dish is already present in your finalOrder list , do make updations there only instead of ordering a new one"
      );
    }
  ...
  return (
    <div className="HomeCont">
            ...
            <div key={el._id} className="dish">
              ...
              >
                ...
                <div className="card_body">
                  ...
                  <div className="lower_data d-flex  justify-content-between"></div>
                  ...
                  <div className="last_data d-flex justify-content-between align-items-center">
                    ...
                    <button onClick={() => check(el._id)} className="butns">
                      Add
                    </button>
                  </div>
                </div>
      ...
      <div className="pagination-btns">
        ...
        {pages.map((el) => {
          return (
            <button key={el} onClick={() => fetchSomeData(el - 1)}>
              {el}
            </button>
          );
        })}
